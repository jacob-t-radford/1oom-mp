...
extern void ui_fleet_print_fleets_orbit(const struct game_s *g, int api, planet_id_t planet_i, bool show_my, bool show_opp);
extern void ui_fleet_print_fleet_enroute(const struct game_s *g, int api, const struct fleet_enroute_s *r, planet_id_t pon);
